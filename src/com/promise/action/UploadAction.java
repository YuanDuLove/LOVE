...
public class UploadAction extends ActionSupport{
    ...
    private ModifyUserPhotoService modifyService;
   
	public void setModifyService(ModifyUserPhotoService modifyService) {
...
//            String userPhotoSrc = new File(new File(realpath),filename).getPath();
            ...
            modifyService.setMapDto(dto);
            boolean b = modifyService.modifyUserPhoto();
        }
        return "success";
    }
